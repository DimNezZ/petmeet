    ...
    <div class="petcard_wrapper">
        ...
        <div class="petcard_info">
            ...
            <div class="button_container">
                <CustomButton @click="data.visible = true">Открыть</CustomButton>
                <CustomButton variant="secondary">Редактировать</CustomButton>
            </div>
        </div>
    </div>
    <PetModal :open="data.visible" @close="data.visible = false"/>
</template>
